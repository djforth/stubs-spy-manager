...
var CreateSpy = function CreateSpy(spyManager) {
  return function (spy) {
    if (_lodash2.default.has(spy, 'callback') || _lodash2.default.has(spy, 'returnSpy')) {
      var title = spy.title;
      var returnType = spy.returnType;
      var callback = spy.callback;
      var returnSpy = spy.returnSpy;

      title = _lodash2.default.isArray(title) ? title : [title];
      if (returnSpy) {
        // spy = createSpy(spy);
...
var CreateStub = function CreateStub(stubs, createSpy) {
  return function (stub) {
    if (_lodash2.default.has(stub, 'callback') || _lodash2.default.has(stub, 'spy')) {
