...
var _reset_spies2 = _interopRequireDefault(_reset_spies);
...
exports.default = function (module) {
  ...
  obj = {
    ...
    getFn: function getFn(mod) {
      return module.__GetDependancy__(mod);
    },
    ...
    reset: function reset() {
      if (_lodash2.default.isFunction(stubs_reset)) stubs_reset();
      spies_list.forEach(_reset_spies2.default);
      return obj;
    }
  };
